...
#define _EMA_ALPHA 0.8      // EMA weight (range: 0 to 1)
...
// Replace the below line with the equation obtained from nonlinear regression analysis
  return 431-1.42*a_value+1.8E-03*pow(a_value,2)-1.01E-06*pow(a_value,3);
}
