...
#define _DUTY_MIN 1000.0 // servo full clockwise position (0 degree)
#define _DUTY_NEU 1500.0 // servo neutral position (90 degree)
#define _DUTY_MAX 2000.0 // servo full counterclockwise position (180 degree)
...
void loop() {
  ...
  if(_DIST_MIN < dist_raw < _DIST_MAX) {
    myservo.writeMicroseconds((dist_raw-_DIST_MIN)*1000.0/_TARGET_LOW +_DUTY_MIN);
  }
